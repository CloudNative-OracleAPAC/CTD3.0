...
<img src="img/lab3-1-19c.png" width="40%"/>

<img src="img/lab3-1-19d.png" width="100%"/>

- Confirm the API has been associated with the Mobile Backend and click back to **Home** in the main menu.
...
In Lab 4, you will learn to configure the Bot to use a "**Instant App**" to build a Wizard to design a sandwich.
