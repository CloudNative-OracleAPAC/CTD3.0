...
4. Select the new channel from the list and select your named **Skill* from the Pop-List associated with the **``Route To``** field.

<img src="img/lab5-1-5.png" width="50%"/>

5. Token the **``Channel Enabled``** switch to **ON** and copy the **App Id** value to a text editor for later use.
